...
// It's usually good practice to store monetary values in cents in your db 
...
//Next.js has a Client-side Router Cache that stores the route segments in the user's
//browser for a time. Along with prefetching, this cache ensures that users can quickly 
//navigate between routes while reducing the number of requests made to the server.
